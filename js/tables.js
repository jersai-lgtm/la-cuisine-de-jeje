...
function getUniteRecette(nom, n) {
  const unites = {
    ...
    "glacepistache":        ["bac", "bacs"],
    "glacecafe":            ["bac", "bacs"],
    "glacecaramel":         ["bac", "bacs"],
    "glacestracciatella":   ["bac", "bacs"],
    "glacementhe":          ["bac", "bacs"],
    "glacerhumraisin":      ["bac", "bacs"],
    "sorbetcitron":         ["bac", "bacs"],
    "sorbetframboise":      ["bac", "bacs"],
    "sorbetmangue":         ["bac", "bacs"],
    "sorbetpassion":        ["bac", "bacs"],
    "sorbetpoire":          ["bac", "bacs"],
    "sorbetfraise":         ["bac", "bacs"],
    "gelato":               ["bac", "bacs"],
    "granite":              ["bac", "bacs"],
