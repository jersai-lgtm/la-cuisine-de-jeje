    ...
    div.innerHTML =
      ...
      '<div class="plan-repas-row" style="grid-template-columns:1fr">' +
        '<div class="plan-repas" onclick="ouvrirRecettePlan(\'' + key + '\', ' + personnes + ')">' +
          '<div class="plan-repas-label" style="justify-content:center">🥡 Lunch <button class="plan-regen-btn" onclick="event.stopPropagation();regenLunchbox(\'' + jour.jour + '\')" title="Remplacer ce plat">🔄</button><button class="plan-regen-btn" onclick="event.stopPropagation();maChoisir(\'' + jour.jour + '\',\'midi\')" title="Choisir une recette">🔍</button></div>' +
