...
const AIDE_TOUR = [
  { emoji: "👋", titre: "Bienvenue chez Jéjé !",
    texte: "Plus de 3500 recettes du monde entier, des menus tout prêts et plein d'outils pour cuisiner sans prise de tête. On fait un tour rapide ? (Tu peux passer à tout moment.)",
    titreEn: "Welcome to Jéjé's Kitchen!",
    texteEn: "Over 3500 recipes from around the world, ready-made menus and loads of tools to cook without the fuss. Shall we take a quick tour? (You can skip anytime.)" },
